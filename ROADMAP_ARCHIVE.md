...
- ✓ Action rules reference channels by name (e.g. `channels: [pond-alerts, deterrent-webhook]`)
...
- Models loaded sequentially to conserve GPU memory; GPU cache freed between runs
