...
Identical in purpose to the detector's config_watcher; duplicated here because
the services have separate Python paths and no shared source installation.
"""
